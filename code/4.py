...
speeds = {'car':1.4, 'bus':1, 'truck':1, 'rickshaw':1.3, 'bike':1.8}  # average speeds of vehicles
...
def generateVehicles():
    T0=[100,120,130,210,500]
    T1=[80,90,90,100,160]
    T2=[40,50,60,140,270]
    T3=[80,110,130,160,280]
    while(True):

                
        temp = random.randint(0,1129)
        direction_number = 0
        a = [415,565,810,1130]
        if(temp<a[0]):
            direction_number = 0

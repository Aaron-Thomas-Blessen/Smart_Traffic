...
signals = []
noOfSignals = 4
simTime = 700       # change this to change time of simulation
timeElapsed = 0
...
speeds = {'car':0.7, 'bus':0.5, 'truck':0.5, 'rickshaw':0.65, 'bike':0.9}  # average speeds of vehicles
